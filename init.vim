...
source $HOME/.config/nvim/modules/coc_snippets.vim
...
source $HOME/.config/nvim/modules/markdown_preview.vim
source $HOME/.config/nvim/modules/floatterm.vim
source $HOME/.config/nvim/modules/far.vim
